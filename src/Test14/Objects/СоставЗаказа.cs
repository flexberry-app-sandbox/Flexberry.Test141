...
namespace IIS.Test14
{
    ...
    [View("СоставЗаказаE", new string[] {
            ...
            "Товары.ЦенаЗаЕд as \'Цена за единицу\'"}, Hidden=new string[] {
            "Товары.Название"})]
    ...
    public class СоставЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Test14.Товары fТовары;
        
        private IIS.Test14.Заказы fЗаказы;
        ...
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.Test14.Товары Товары
        {
            get
            {
                ...
                IIS.Test14.Товары result = this.fТовары;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Test14.Заказы.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказы"})]
        public virtual IIS.Test14.Заказы Заказы
        {
            get
            {
                ...
                IIS.Test14.Заказы result = this.fЗаказы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставЗаказаE", typeof(IIS.Test14.СоставЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Test14.DetailArrayOfСоставЗаказа members)

        // *** End programmer edit section *** (IIS.Test14.DetailArrayOfСоставЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСоставЗаказа(IIS.Test14.Заказы fЗаказы) : 
                base(typeof(СоставЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказы)))
        {
        }
        
        public IIS.Test14.СоставЗаказа this[int index]
        {
            get
            {
                return ((IIS.Test14.СоставЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Test14.СоставЗаказа dataobject)
        {
