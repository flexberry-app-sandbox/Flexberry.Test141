...
(
	...
	"ЦенаЗаЕд" NUMBER(10) NULL,

	"Название" NVARCHAR2(255) NULL,

	"ВНаличии" RAW(16) NOT NULL,
...
ALTER TABLE "Товары"
	ADD CONSTRAINT "Товары_FВНали_3905" FOREIGN KEY ("ВНаличии") REFERENCES "ВНаличии" ("primaryKey");

CREATE INDEX "Товары_IВНаличии" on "Товары" ("ВНаличии");
